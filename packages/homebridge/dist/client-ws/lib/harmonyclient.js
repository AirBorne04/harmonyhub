...
let HarmonyClient = HarmonyClient_1 = class HarmonyClient extends events_1.EventEmitter {
    ...
    _connect(hubip) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.wsClient = new WebSocketAsPromised(url, {
                createWebSocket: (urlString) => new websocket_1.w3cwebsocket(urlString),
    ...
    isOff() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const activityId = yield this.getCurrentActivity(), off = (activityId === '-1');
     ...
     */
    send(action, body, commandTimeframe = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            let encodedAction;
            if (typeof body === 'string') {
                ...
                return Promise.reject('With the send command you need to provide a body parameter which ' +
            ...
            }, payloadRelease = Object.assign({}, payloadPress, { hbus: Object.assign({}, payloadPress.hbus, { params: Object.assign({}, payloadPress.hbus.params, { timestamp: commandTimeframe, status: 'release' }) }) });
