...
function getIdentity(hubhost, hubport) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            var iqId, xmppClient = new Client({
 ...
 *
 * Returns:
 *     (Promise) - When resolved, passes the logged in XMPP client, ready to
...
function loginWithIdentity(identity, hubhost, hubport) {
    ...
    return new Promise((resolve, reject) => {
        var jid = identity + '@connect.logitech.com/gatorade', password = identity, xmppClient = new Client({
            jid: jid,
            password: password,
            host: hubhost,
            port: hubport,
